...
<div class="wrapper">
    <div class="login-box">
        <div class="mb-small">
        <div class="login-header">Streamer login</div>
            <form action="includes/login.inc.php" method="post" class="login-form">
                ...
                <button class="login-button" style="margin-top: 10px;" type="submit" name="submitStreamer">Login</button>
            </form>
        </div>
        <div>
            <a class="link" href="loginUser.php">
                Login as viewer
            </a>
        </div>
        <div>
